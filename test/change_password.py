...
r = requests.post("http://127.0.0.1/forgot_password", json=first_datas)
print(r, r.text)
otp = input("otp:")
forgot_datas = {"type":"forgot_password", "otp":otp, "uid":uid}
r = requests.post("http://127.0.0.1/forgot_password", json=forgot_datas)
print(r, r.text)
...
if received_datas["status"] == "success":
    ...
    r = requests.post("http://127.0.0.1/forgot_password", json=reset_datas)
    print(r, r.text)